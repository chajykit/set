...
class GameSprite(sprite.Sprite):
    def __init__(self,player_image1,player_image2,ballx,bally,size_x,size_y,ball_speed,):
        super().__init__()
        self.image1 = transform.scale(image.load(player_image1),(5,10))
        self.image2 = transform.scale(image.load(player_image2),(5,10))
...
ball = GameSprite('ракетка.png','ракетка.png',10,10,30,15,10)
speed_x = 3
speed_y = 3
...
'''class Player(GameSprite):
    ...
    def fire(self):
        ...
        bullets.add(bullet)
player = Player("rocket.png",350,450,80,100,10)
